...
<body>
    <div id="app" class="h5">
        <nav class="navbar navbar-expand-md navbar-dark bg-primary shadow-sm" id="navbar-example2">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item n">
                            <a class="nav-link " href="{{route('todos.index')}}" role="button">Todos</a>
                        </li>
                        <li class="nav-item n">
                            ...
                            <div class="dropdown nav-button notifications-button hidden-sm-down">
                                ...
                                <div class="dropdown-menu notification-dropdown-menu"
                                        ...
                                        <div class="notifications-body">
                                            <p class="notification-texte mx-1">
                                                <small><span
                                                    ...
                                                    t'a affecté la todo {{ $notification->data['todo_name'] }}</small>
                                            </p>
                                        </div>
                                    ...
                                    <a id="notificationAucune" class="dropdown-item dropdown-notification" href="#">
                                        <p class="notification-solo text-center">Not New Notification</p>
                                    </a>
                                    @endif
                                    {{--  <!-- TOUTES -->
